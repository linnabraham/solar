...
if __name__ == "__main__":
    ...
    X_train, y_train = extract_percentiles_generator(train_ds)
    X_val, y_val = extract_percentiles_generator(val_ds)
    ...
    best_model_path = "best_xgboost_model_b2.json"  # Path to save the best model
    # Train the model
